...
public class Solution {
    ...
    public static Integer findDuplicate(int[] theArray) {

        int idx = 0 ;
        int val_at_next_idx = 0 ;
        int next_idx = 0 ;
        int store = 0 ;
        while (idx < theArray.length) {
            next_idx = theArray[idx] ;
            ...
            val_at_next_idx = theArray[next_idx] ;

            while ( val_at_next_idx != next_idx ) {
                theArray[next_idx] = next_idx ;
